...
def pdff(k):
    t.sleep(2)
    roh=lib.get_element_attribute("id:receipt","outerHTML")
    pdf=PDF()
    pdf.html_to_pdf(roh,f"output/receipts_{k}.pdf")
    # pdff()
...
def fill_all_excel():
    ...
    while i<it:
        try:
            ...
            lib.input_text("xpath:/html/body/div/div/div[1]/div/div[1]/form/div[4]/input",str(list(df["Address"])[i]))
